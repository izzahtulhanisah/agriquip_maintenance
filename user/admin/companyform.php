...
<div id="wrapper">
 	...
 	<div class="blank">
		...
		<?php
				...
				$sql = "INSERT INTO company (company_name,company_code,description)
				    VALUES ('$company_name','$company_code','$description')";
				$result = mysqli_query($conn,$sql);


				if($result === TRUE){
					echo "<script type = \"text/javascript\">
						alert(\"Successfully Added New Company\");
					...
					echo "<script type = \"text/javascript\">
						...
						window.location = (\"companyform.php\")
						</script>";
					}
				}
				?>
			...
			<div class="blank-page">
				...
				<div class="header">
						<h4 class="title"><center>COMPANY REGISTRATION FORM</center></h4>
				</div>
				<hr>
				<div class="content">
						<form action="" method="post">
								<div class="row">
										<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control border-input" name="company_name" placeholder="Eg: Malaysia Airlines">
												</div>
										</div>
										...
										<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control border-input" name="company_code" placeholder="Eg: MH">
												</div>
										</div>
								</div>
								...
								<div class="row">
						                ...
						                placeholder="5 years contract"></textarea>
												</div>
										</div>
								</div>
